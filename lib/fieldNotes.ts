...
// To add a new monthly post, append an entry to POSTS below.
...
export const POSTS: FieldNote[] = [
  {
    ...
    date: "January 2025",
    theme: "Regenerative Development",
    title: "A working definition, and why precision matters",
    teaser: "Sustainability and regenerative development are treated as synonyms. They describe different design briefs and different outcomes.",
  ...
  },
  {
    ...
    teaser: "Two sites with identical panel counts can differ in annual yield by 15 percent or more, purely on tilt, azimuth, and tracking design matched to local irradiance.",
  ...
  },
  {
    ...
    date: "March 2025",
    theme: "Land & Regenerative Agriculture",
    title: "Agrivoltaics and the economics of dual land use",
    teaser: "Treating energy and food production as competing land uses is a modeling error, not a physical constraint.",
  ...
  },
  {
    ...
    teaser: "Reservoir yield and watershed condition are as material to a project's viability as interconnection queue position, and are diligenced with a fraction of the rigor.",
  ...
  },
  {
    ...
    date: "May 2025",
    theme: "EPC & Project Delivery",
    title: "The risk that lives between financial close and energization",
    teaser: "Capital treats financial close as the finish line. Procurement, interconnection sequencing, and contractor capacity treat it as the starting point.",
  ...
  },
  {
    ...
    date: "June 2025",
    theme: "Sustainable Real Estate",
    title: "Real assets, disclosure, and the EU's recalibration of reporting scope",
    teaser: "Europe narrowed mandatory sustainability disclosure this year. That does not reduce what serious institutional capital expects to see.",
  ...
  },
  {
    ...
    date: "June 2025",
    theme: "Materials & Embodied Carbon",
    title: "The building material is now a capital decision",
    teaser: "Structural material choice can account for a third of a building's lifetime carbon footprint before a single day of operation.",
  ...
  },
  {
    ...
    teaser: "The fastest-permitted waste to energy facilities are rarely the most technically advanced. They are the ones designed to be used by the public, not merely tolerated by it.",
  ...
  },
  {
    ...
    date: "August 2025",
    theme: "Capital Introduction",
    title: "What clears institutional diligence, and what does not",
    teaser: "Family offices and infrastructure funds review a high volume of opportunities each year. The variable that predicts a second meeting is rarely the return projection.",
  ...
  },
  {
    ...
    date: "September 2025",
    theme: "Orbital & Earth Observation",
    title: "Verification from orbit as a condition of capital",
    teaser: "Long-horizon land and agriculture positions increasingly require proof of environmental performance that does not depend on self-reported data.",
  ...
  },
  {
    ...
    date: "October 2025",
    theme: "Mobility & EV Infrastructure",
    title: "Charging infrastructure is a land use and grid-planning decision",
    teaser: "EV charging is typically scoped as a technology deployment. The siting decision behind it determines development patterns for a decade.",
  ...
  },
  {
    ...
    date: "November 2025",
    theme: "Community & Human Health",
    title: "Energy reliability as a public health input",
    teaser: "A rural health facility without dependable power is a building, not a functioning health system. Energy access sits upstream of most public health outcomes it enables.",
  ...
  },
  {
    ...
    date: "November 2025",
    theme: "Story of Place & Wellbeing",
    title: "What a place is for, before what it contains",
    teaser: "The developments that hold long term value are rarely defined first by unit count or floor area. They start from what a place has historically been, and what it is for.",
  ...
  },
  {
    ...
    date: "December 2025",
    theme: "Carbon & Environmental Markets",
    title: "COP30 and the verification gap in nature based finance",
    teaser: "COP30 closed in Belém on 22 November with an agreement to substantially increase adaptation finance for developing countries. The harder problem it did not solve is measurement.",
  ...
  },
  {
    ...
    date: "January 2026",
    theme: "Land & Due Diligence",
    title: "A land selection framework for the year ahead",
    teaser: "Heading into 2026, the constraint on new development is rarely capital availability. It is the supply of land that clears diligence on water, grid, and title simultaneously.",
  ...
  },
  {
    ...
    teaser: "Wind sold as raw megawatt-hours into a grid is a commodity business. Wind paired with storage and located next to an industrial or agricultural load is a different asset entirely.",
  ...
  },
  {
    ...
    teaser: "In the frontier markets where a meaningful share of our pipeline sits, water infrastructure is rarely the first investment. It follows power, because it depends on power.",
  ...
  },
  {
    ...
    date: "April 2026",
    theme: "EPC & Grid Interconnection",
    title: "The interconnection queue, not capital, is the binding constraint",
    teaser: "In market after market, projects with committed capital and secured land now wait years for a grid interconnection study. That queue, not financing, decides who builds first.",
  ...
  },
  {
    ...
    teaser: "Districts that reliably achieve net zero operation are planned as one coordinated energy, water, and mobility system from the master plan stage, not assembled building by building.",
  ...
  },
  {
    ...
    date: "June 2026",
    theme: "Waste & Circular Materials",
    title: "One waste stream, four potential outputs",
    teaser: "Modern conversion technology can extract power, heat, recovered materials, and industrial feedstock from a single waste stream. Most facilities are still configured to produce only one.",
  ...
  },
  {
    ...
    teaser: "What began as an optional differentiator on land heavy deals is increasingly a standing request from capital partners across every asset class we work in.",
  ...
  },
  {
    ...
    date: "August 2026",
    theme: "Capital Markets & Real Assets",
    title: "What the EU's finalized disclosure rules mean for real asset underwriting",
    teaser: "With the Omnibus I Directive published in February, European sustainability disclosure now has a narrower, clearer scope. That clarity is starting to show up in how real asset deals are structured.",
